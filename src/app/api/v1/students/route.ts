...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    if (e.code === 'DUPLICATE_POSSIBLE') {
      return Errors.business('DUPLICATE_POSSIBLE', e.message, 409)
    }
    return Errors.business('STUDENT_CREATE_FAILED', e.message || 'Failed to create student', 422)
  }
