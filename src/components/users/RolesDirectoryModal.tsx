...
const ROLE_CONFIGS: Record<string, RoleConfig> = {
  ...
  HELPER: {
    icon: HeartHandshake,
    title: 'Care Helper',
    badgeText: 'Helper / Support Staff',
    badgeCls: 'b-teal',
    category: 'WORKFORCE',
    categoryLabel: 'Preschool Workforce',
    tierLabel: 'Tier 2 • Support Caretaker',
    scope: 'Assigned Campus / Classroom',
    boundary: 'Operational Support Scope',
    tagline: 'Classroom caretaking assistance, child welfare support, and campus operational duties',
    accentColor: '#0D9488',
    iconBg: '#CCFBF1',
    iconColor: '#0F766E',
    policyTitle: 'Classroom Support & Child Welfare Scope',
    policyText: 'Helpers assist with student care, hygiene, and classroom logistics. Financial ledgers, student records editing, and admissions approvals are strictly restricted.',
    policyType: 'info',
  },
  ACCOUNTANT: {
    icon: CircleDollarSign,
    title: 'Campus Accountant',
    ...
    tagline: 'Fee schedules, student invoicing, offline/online collections, receipts, and financial ledgers',
    accentColor: '#D97706',
    iconBg: '#FEF3C7',
    iconColor: '#B45309',
    policyTitle: 'Financial Segregation of Duties',
    policyText: 'Accountants possess full authorization over fee structures, student invoices, receipt reconciliation, and staff payroll. Academic evaluations and student attendance modification are segregated out of scope.',
    policyType: 'warning',
  },
  HR: {
    icon: Users,
    ...
    category: 'WORKFORCE',
    categoryLabel: 'Preschool Workforce',
    tierLabel: 'Tier 2 • Workforce Officer',
    scope: 'Campus / Branch Workforce',
    boundary: 'Employee Records & Leaves',
    tagline: 'Staff onboarding, leave administration, attendance tracking, and workforce documentation',
    accentColor: '#4F46E5',
    iconBg: '#E0E7FF',
    iconColor: '#4338CA',
    policyTitle: 'Workforce Administration Boundary',
    policyText: 'HR manages teacher onboarding, attendance records, leave approvals, and employment agreements. Student medical records and tuition billing are strictly restricted.',
    policyType: 'info',
  },
  DRIVER: {
    icon: Bus,
